 ...
 * Licensed GPLv3 Copyrights Tabernacle Heavens 2017*/
! function (a, b) {
    ...
    ! function () {
        ...
        b.prototype.init = function () {
            ...
            var b, c = "",
                ...
                f = "",
                g = this;
            for (a("body").append('<div class="lg-backdrop" tabindex="-1"></div>'), a(".lg-backdrop").css("transition-duration", this.s.backdropDuration + "ms"), e = 0; e < this.$items.length; e++) c += '<div class="lg-item"></div>';
...
function (a, b) {
    ...
    ! function () {
        ...
        c.prototype.init = function () {
            ...
            c += b.core.s.facebook ? '<li><a id="lg-share-facebook" target="_blank"><span class="fa fa-facebook"></span><span class="lg-dropdown-text">' + this.core.s.facebookDropdownText + "</span></a></li>" : "", c += b.core.s.twitter ? '<li><a id="lg-share-twitter" target="_blank"><span class="fa fa-twitter"></span><span class="lg-dropdown-text">' + this.core.s.twitterDropdownText + "</span></a></li>" : "", c += b.core.s.googlePlus ? '<li><a id="lg-share-googleplus" target="_blank"><span class="fa fa-google-plus"></span><span class="lg-dropdown-text">' + this.core.s.googlePlusDropdownText + "</span></a></li>" : "", c += b.core.s.pinterest ? '<li><a id="lg-share-pinterest" target="_blank"><span class="fa fa-pinterest"></span><span class="lg-dropdown-text">' + this.core.s.pinterestDropdownText + "</span></a></li>" : "", c += "</ul></span>", this.core.$outer.find(".lg-toolbar").append(c), this.core.$outer.find(".lg").append('<div id="lg-dropdown-overlay"></div>'), a("#lg-share").on("click.lg", function () {
